...
const SearchMapPage = loadable(() => import(/* webpackChunkName: "SearchMapPage" */ '../containers/SearchMapPage/SearchMapPage'));
...
const routeConfiguration = (layoutConfig, accessControlConfig) => {
  ...
  return [
    ...
    {
      path: '/post-from-draft',
      name: 'PostFromDraftPage',
      auth: true,
      authPage: 'SignupPage',
      component: PostFromDraftPage,
      loadData: pageDataLoadingAPI.PostFromDraftPage.loadData,
    },
    {
