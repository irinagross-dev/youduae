...
// Импортируем обе локали для moment
...
const hardCodedLocale = process.env.NODE_ENV === 'test' ? 'en' : preferredLang;

// Импортируем оба файла переводов
import messagesInLocaleRu from '../translations/ru.json';
import messagesInLocaleEn from '../translations/en.json';

const messagesInLocale = preferredLang === 'en' ? messagesInLocaleEn : messagesInLocaleRu;
...
const defaultConfig = {
  ...
  address: {
    addressCountry: null, // 'UAE',
    addressRegion: null, // 'Dubai',
    postalCode: null, // '001234',
    streetAddress: null, // 'Bluewaters island',
  },
};
