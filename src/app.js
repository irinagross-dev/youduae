...
// Загружаем файл переводов в зависимости от выбранного языка
const preferredLang = getPreferredLanguage();
import defaultMessagesRu from './translations/ru.json';
import defaultMessagesEn from './translations/en.json';

const defaultMessages = preferredLang === 'en' ? defaultMessagesEn : defaultMessagesRu;
...
const messagesInLocale = defaultMessages;
...
const MomentLocaleLoader = props => {
  ...
  const MomentLocale =
    ['en', 'en-US'].includes(locale) || isAlreadyImportedLocale
      ...
      ? loadable.lib(() => import(/* webpackChunkName: "ru" */ 'moment/locale/ru'))
