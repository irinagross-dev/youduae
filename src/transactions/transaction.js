...
import * as assignmentProcess from './transactionProcessAssignment';
...
export const ASSIGNMENT_PROCESS_NAME = 'assignment-flow-v3';
...
const PROCESSES = [
  ...
  {
    name: ASSIGNMENT_PROCESS_NAME,
    alias: `${ASSIGNMENT_PROCESS_NAME}/release-1`,
    process: assignmentProcess,
    unitTypes: [INQUIRY], // Using INQUIRY unit type for assignment tasks
  },
];
...
export const resolveLatestProcessName = processName => {
  switch (processName) {
    ...
    case ASSIGNMENT_PROCESS_NAME:
    case 'assignment-flow-v3/release-1':
      return ASSIGNMENT_PROCESS_NAME;
    default:
      return processName;
  }
};
