...
const ModerationStatusBadge = ({ listing }) => {
  const moderationStatus = listing?.attributes?.publicData?.moderationStatus;
  const moderationReason = listing?.attributes?.publicData?.moderationReason;
  ...
  return (
    <div className={classes}>
      ...
      <div className={css.info}>
        ...
        <ModerationStatusBadge listing={currentListing} />
      </div>
    </div>
  );
};
