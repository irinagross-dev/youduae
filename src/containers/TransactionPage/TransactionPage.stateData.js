...
import { getStateDataForAssignmentProcess } from './TransactionPage.stateDataAssignment.js';
...
export const getStateData = (params, process) => {
  ...
  const getLeaveReviewProps = (transitionName, forRole) => 
    getActionButtonPropsMaybe(
      {
        processName,
  ...
  } else if (processName === ASSIGNMENT_PROCESS_NAME) {
    return getStateDataForAssignmentProcess(params, processInfo());
  } else {
    return {};
  }
};
