    ...
    <div className={css.item}>
      ...
      >
        ...
        <div className={css.itemUsername}>
          ...
          <VerificationBadge isVerified={isOtherUserVerified} />
        </div>
      ...
      <div className={css.container}>
        ...
        <div className={css.header}>
          ...
          <div className={css.tabsContainer}>
            ...
            {/* Подтабы для фильтрации по статусам */}
            <TabNav 
              rootClassName={css.subtabs} 
              tabRootClassName={css.subtab} 
              tabs={statusSubtabs} 
            />
          </div>
        </div>
