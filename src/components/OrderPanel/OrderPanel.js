...
const OrderPanel = props => {
  ...
  console.log('🔍 OrderPanel access check:', {
    ...
    isOnlyCustomer,
    isOwnListing,
    isProviderViewingOthersListing,
    currentUser: currentUser?.id?.uuid,
    listingAuthor: listing?.author?.id?.uuid,
  });
    ...
    <div className={classes}>
      ...
      <div className={css.openOrderForm}>
        ...
        {isClosed ? (
          ...
          <div className={css.providerCannotRespondMessage}>
            <FormattedMessage id="OrderPanel.providerCannotRespond" />
          </div>
        ) : (
          <PrimaryButton
